    ...
    <section class="content">
        <div class="card">
            <div class="card-header">
                <button type="button" class="btn btn-block btn-outline-primary btn-lg" data-toggle="modal" data-target="#exampleModal" >Ajouter une source</button>
            </div>
        ...
        @else
            ...
            @foreach ($items as $item)
                <div class="callout callout-info">
                    ...
                    @else
                        <a style="color: blue; text-decoration: none;" href="{{$item->get_permalink()}}"><h5>{{$item->get_title()}}</h5></a>
                        <p>{{$item->get_date()}}</p>
